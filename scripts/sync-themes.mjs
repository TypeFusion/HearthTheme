...
const TOKENS_TS_PATH = SITE_TOKENS_PATH
...
const targets = [SITE_PUBLIC_THEMES_DIR, EXTENSION_THEMES_DIR]
...
// 2. 由 builder 输出 web token maps，生成 packages/site/src/data/tokens.ts
