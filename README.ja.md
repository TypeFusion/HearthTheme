...
主要ディレクトリ: `color-system/`, `themes/`（生成成果物）, `extension/`, `obsidian/`, `src/`, `scripts/`。
...
- セマンティック色ソース: `color-system/semantic.json`
- アダプター契約ソース: `color-system/adapters.json`
- バリアントルーティングソース: `color-system/variants.json`
- チューニングプロファイルソース: `color-system/tuning.json`
- チューニング項目リファレンス: `docs/color-system-tuning.md`
